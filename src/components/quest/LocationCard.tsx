      ...
      >
        ...
        >
          ...
          <div className="absolute top-2 left-2 w-6 h-6 rounded-full border border-[#d4cdbc] bg-[#191713]/80 flex items-center justify-center">
            <span className="font-[family-name:var(--font-cinzel)] text-[12px] text-[#d4cdbc]">
        ...
        <div className="p-4 flex flex-col gap-3 flex-1">
          <div>
            <h2 className="font-[family-name:var(--font-new-rocker)] text-sm font-semibold text-[#aea99b] tracking-wide leading-snug">
              {location.name}
            </h2>
            <p className="mt-1 text-[#868174] text-xs font-[family-name:var(--font-im-fell)] leading-relaxed">
          ...
          <div className="border-t border-[#433f37] pt-3">
            <p className="text-[12px] font-[family-name:var(--font-cinzel)] tracking-[0.25em] text-[#d4cdbc] uppercase mb-1">
              The Task
            </p>
            <p className="text-xs text-[#868174] font-[family-name:var(--font-im-fell)] ">
          ...
          <div className="border-t border-[#433f37] pt-3">
            <a
              ...
              className="inline-flex items-center gap-2 text-[12px] font-[family-name:var(--font-cinzel)] tracking-[0.15em] uppercase text-[#d4cdbc] border border-[#d4cdbc40] px-3 py-1.5 rounded-sm hover:border-[#d4cdbc] hover:bg-[#d4cdbc10] transition-all"
            >
              <svg
                className="w-3 h-3"
                viewBox="0 0 24 24"
          ...
          <div className="mt-auto pt-2">
            {isApproved ? (
              <div className="text-center py-2">
                <span className="font-[family-name:var(--font-cinzel)] text-[12px] tracking-widest text-green-400 uppercase">
                  ✦ Completed ✦
                </span>
              </div>
            ) : isPending ? (
              <div className="text-center py-2">
                <span className="font-[family-name:var(--font-cinzel)] text-[12px] tracking-widest text-amber-400 uppercase">
                  Awaiting Review…
                </span>
              </div>
            ) : (
